...
(function (factory) {
    ...
    $.fn.timeTo = function () {
        ...
        return this.each(function () {
            var $this = $(this);
            var data = $this.data();
            var defs, opt, i, css, language, left, ulhtml, style, dhtml1, dhtml2, dhtmlDay, dot2, dot3, maxWidth,
            ...
            if (!data.vals) {
                ...
                dhtmlDay = '<div class="day"' + style + '>' + ulhtml;
                dhtml2 = '<div' + style + '>' + ulhtml;
                dot2 = '<span class="separator"></span>';
                dot3 = '<span class="separator2"></span>';
                ...
                thtml = (data.displayCaptions
                    ? (data.displayHours
                        ...
                        + '</figcaption></figure>'
                    : (data.displayHours ? '$1' + dot2 : '') + '$1' + dot3 + '$1'
